...
dat <- read.csv("/Users/Roshan/Desktop/Machine Learning/Stocks/Oil/Chevron.csv", header = TRUE)

set.seed(42)

## Features slected after the feature selection
vars <- c("X50.calendar.day.moving.average","assetnew", "betanew", "Enterprise.Value",
          "EBITDA_mn" , "Open..Nasdaq.", "Price.of.Oil",
          "returnnew", "X50.Day.Simple.Moving.Average..S.P.500.", "tobin_mn",
          "PE.Ratio..TTM.", "Volume","Indicator")
Ycolumn <- "Indicator"
